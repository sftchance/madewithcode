export default class Context {
	...
	constructor(React: any) {
		...
		if (
			!(
				Object.prototype.hasOwnProperty.call(window, "Babel") &&
	...
	private _checkBabelOptions(babelOptions: any): void {
		if (
			Object.prototype.toString.call(babelOptions) !== "[object Object]"
		) {
			throw new Error(
		...
		if (!Object.prototype.hasOwnProperty.call(babelOptions, "presets")) {
			...
			if (
				!(
					typeof babelOptions.presets === "object" &&
					babelOptions.presets.constructor == Array
				)
			) {
				throw new Error(
	...
	/// Generate the component from the template string.
	...
	/// Confirm that the code inside the template string is a stringified
	// functional component by checking function type compliace as a
	// React component is declared with the type of React.FC<any>.
	...
	/// Confirm that the template string is a string and not an empty string.
	...
	/// Update the template string and generate the component from it.
	...
	/// Get the component generated from the template string that is
